...
const ProjectModal = ({ project, onClose }) => {
    ...
    return (
        ...
        >
            ...
            <button
                onClick={onClose}
                className="fixed top-4 right-4 md:top-6 md:right-6 z-[110] w-10 h-10 md:w-14 md:h-14 rounded-full bg-black/50 hover:bg-black/70 backdrop-blur-xl border border-white/10 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:rotate-90"
            >
            ...
            <div className="relative min-h-screen py-4 md:py-12">
                <div className="relative w-full max-w-6xl mx-auto bg-gradient-to-b from-black/95 to-black/90 rounded-xl md:rounded-3xl backdrop-blur-xl border border-white/10 overflow-hidden shadow-2xl shadow-purple-500/20">
                    ...
                    <div className="relative w-full aspect-[16/9] overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-12">
                            ...
                            <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-white mb-2 md:mb-4">{project.title}</h2>
                        ...
                        <div className="mt-8 md:mt-16 flex flex-col sm:flex-row gap-4 md:gap-6">
                            {project.liveUrl && (
                                <a
                                    ...
                                    className="px-6 md:px-8 py-3 md:py-4 rounded-xl bg-gradient-to-r from-purple-500 to-blue-500 text-white text-sm md:text-base font-medium hover:shadow-lg hover:shadow-purple-500/30 transition-all duration-300 flex items-center justify-center"
                                >
                            ...
                            {project.githubUrl && (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="px-6 md:px-8 py-3 md:py-4 rounded-xl bg-white/5 text-white text-sm md:text-base font-medium border border-white/10 hover:bg-white/10 transition-all duration-300 flex items-center justify-center"
                                >
